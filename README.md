...
![Main Interface](genomicrag/images/FrontPage.png)

### 2. PDF Upload & Text Chunking
![PDF Upload](genomicrag/images/Upload_and_chunking.png)

### 3. Factual Q&A with Sources
![Q&A with Sources](genomicrag/images/answer.png)

### 4. Non-Genetics Paper Rejection (Domain Guardrail)
![Domain Validation Guardrail](genomicrag/images/Genetic_papers_only.png)
